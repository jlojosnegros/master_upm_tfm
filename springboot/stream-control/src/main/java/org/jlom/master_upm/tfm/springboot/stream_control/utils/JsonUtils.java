package org.jlom.master_upm.tfm.springboot.stream_control.utils;
...
//    return o;
  ...
  public static <T> T retrieveResourceFromResponse(HttpResponse response, Class<T> clazz) throws IOException {
    ...
    return jsonToObject(jsonFromResponse,clazz);
  }

  public static <T> List<T> retrieveListOfResourcesFromResponse(HttpResponse response, Class<T> clazz) throws IOException {
    String jsonFromResponse = EntityUtils.toString(response.getEntity());
    return jsonToList(jsonFromResponse,clazz);
  }
}
